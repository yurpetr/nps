...
gulp.task('watch', () => {
	browserSync.init({ proxy: 'localhost:8080', open: false, });
...
gulp.task('copy-png-and-reload', gulp.series('copy-png', reload));

gulp.task('build', gulp.series('copy-html', 'copy-css', 'copy-js', 'copy-png'));
