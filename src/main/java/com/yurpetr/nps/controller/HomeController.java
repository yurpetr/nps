...
public class HomeController {
	...
	public ModelAndView home(Principal principal) {
		if (principal != null) {
			...
			mav.addObject("pointOfSale", usersService.findByLogin(authentication.getName()).get().getPointOfSale());
			return mav;
	...
	public String doStuffMethod(@RequestParam(value = "id", required = false) String id,
