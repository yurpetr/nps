...
@Service
public class UserService extends UsersService implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		...
		if (user == null) {
			throw new UsernameNotFoundException(String.format("Користувача '%s' не знайдено", username));
		}
